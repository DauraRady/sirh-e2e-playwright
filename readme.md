![Playwright Tests](https://github.com/DauraRady/Playwright-OrangeHRM/actions/workflows/orangehrm-ci.yml/badge.svg)
...
Tests run on every push and PR via [GitHub Actions](.github/workflows/orangehrm-ci.yml). Branch `main` is protected — CI must pass before merging. Reports and traces are uploaded as artifacts on failure.
